...
if [ "$dataset" = 'test_run' ]; then
    ...
    --batch 2048 \
    --batch-gpu 64 \
    --outdir '/data/image_experiment/sid-train-runs/edm2-s' \
    --resume '/data/image_experiment/sid-train-runs/edm2-s' \
    --nosubdir 0 \
    --precond 'edm2' \
    --arch 'edm2-img512-s' \
    ...
    --batch 2048 \
    --batch-gpu 32 \
    --outdir '/data/image_experiment/sid-train-runs/edm2-m' \
    --resume '/data/image_experiment/sid-train-runs/edm2-m' \
    --nosubdir 0 \
    --precond 'edm2' \
    --arch 'edm2-img512-m' \
    ...
    --batch 2048 \
    --batch-gpu 32 \
    --outdir '/data/image_experiment/sid-train-runs/edm2-l' \
    --resume '/data/image_experiment/sid-train-runs/edm2-l' \
    --nosubdir 0 \
    --precond 'edm2' \
    --arch 'edm2-img512-l' \
    ...
    --batch 2048 \
    --batch-gpu 16 \
    --outdir '/data/image_experiment/sid-train-runs/edm2-xl' \
    --resume '/data/image_experiment/sid-train-runs/edm2-xl' \
    --nosubdir 0 \
    --precond 'edm2' \
    --arch 'edm2-img512-xl' \
    ...
    --batch 2048 \
    --batch-gpu 2 \
    --outdir '/data/image_experiment/sid-train-runs/edm2-xxl' \
    --resume '/data/image_experiment/sid-train-runs/edm2-xxl' \
    --nosubdir 0 \
    --precond 'edm2' \
